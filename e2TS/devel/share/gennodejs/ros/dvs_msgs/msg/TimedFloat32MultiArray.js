...
class TimedFloat32MultiArray {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new TimedFloat32MultiArray(null);
  ...
  static datatype() {
    ...
    return 'dvs_msgs/TimedFloat32MultiArray';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new TimedFloat32MultiArray(null);
...
module.exports = TimedFloat32MultiArray;
