...
T_fix = T_gripper_cam @ np.linalg.inv(T_e_rgb) @ T_cam_ned
#  T_fix = T_e_rgb @ T_gripper_cam
print(T_fix)
...
def cb(msg):
    ...
    T_out = T_ned_mocapref @ T_in @ T_fix
...
if __name__ == "__main__":
    ...
    rospy.Subscriber("/vrpn_client_node/Tracker_wx2/pose", PoseStamped, cb)
    rospy.spin()
